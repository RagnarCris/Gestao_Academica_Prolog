...
/* Definição de estudantes iniciais */
...
/* Definição de cursos iniciais */
curso('DCC', 'Ciência da Computação') .
curso('MAT', 'Matemática') .

/* Definição de disciplinas iniciais */
...
/* Definição dos relacionamentos entre estudante e disciplina */
...
/* Definição dos relacionamentos entre disciplina e curso */
